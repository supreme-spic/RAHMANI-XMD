...
setInterval(async () => {
    if (conf.AUTO_BIO === "yes") {
        ...
        const bioText = `RAHMANI_MD is running 🚗\n${currentDateTime}`; // Format the bio text
...
let auto_reply_message = "Hello,its Rahmani Md on board. My owner is currently unavailable. Please leave a message, and we will get back to you as soon as possible.";
