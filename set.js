...
module.exports = { session: process.env.SESSION_ID || 'timoth',
    ...
    AUTO_STATUS_TEXT: process.env.AUTO_STATUS_TEXT || 'Your Status Seen By Rahmani_XMd',   
    ...
    CAPTION : process.env.CAPTION || "Rahmani_Xmd",
    BOT : process.env.BOT_NAME || 'RAHMANI_ZMD',
