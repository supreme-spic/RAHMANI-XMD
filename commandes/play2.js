...
zokou({
  ...
  try {
    ...
    const messagePayloads = [
      {
      caption: `\n*JEEPERS CREEPERS-XMD AUDIOS*\n
╭┈┈┈⊷
┊ *Made:* in kenya/Eldoret 
┊ *Quality:* High
┊ *Powered:* by jeepers creepers 
╰┈┈┈┈┈┈┈┈┈┈┈┈┈⊷
🌐 *Bot Repo:* https://github.com/lovertoxic/JEEPERS-CREEPERS-XMD-.git

> regards alonetech111@gmail.com`,
...
zokou({
  ...
  try {
    ...
    const messagePayloads = [
      {
      caption: `\n*JEEPERS CREEPERS-XMD MD AUDIOS*\n
╭┈┈┈⊷
┊ *Made:* in kenya/Eldoret 
┊ *Quality:* High
┊ *Powered:* by Jeepers creepers 
