...
`,
       ...
       contextInfo: {
          ...
          externalAdReply: {
            title: "Rahmani",
            body: "YouTube Search",
            thumbnailUrl: 'https://files.catbox.moe/aktbgo.jpg', // Add thumbnail URL if required 
      ...
      },
      {
        ...
        contextInfo: {
          ...
          externalAdReply: {
            title: "RahmaniMd",
            body: "YouTube Search",
            thumbnailUrl: 'hhttps://files.catbox.moe/aktbgo.jpg', // Add thumbnail URL if required 
            sourceUrl: '', // Add source URL if necessary
            mediaType: 1,
            renderLargerThumbnail: true
          },
